...
public class WindowSequencer extends WindowMachine {
	protected static Texture progressBase = new StandardTexture(64, 114, 98, 9, ExtraBeeTexture.GUIProgress.getTexture());
